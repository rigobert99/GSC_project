      ...
      <div className="max-w-5xl mx-auto bg-white p-8 rounded-lg shadow-md mt-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input type="text" name="numeroCompte" placeholder="Numéro de compte (MOMO/OM)" value={form.numeroCompte} onChange={handleChange} className="w-full border rounded px-4 py-2" />
