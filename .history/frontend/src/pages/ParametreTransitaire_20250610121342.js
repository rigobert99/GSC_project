        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" name="username" value={form.username} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Email</label>
              <input type="email" name="email" value={form.email} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Mot de passe</label>
              <div className="relative">
                <input type={showPassword ? "text" : "password"} name="password" value={form.password} onChange={handleChange} className="w-full border rounded px-4 py-2 pr-10" />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Prix unitaire (FCFA)</label>
              <input type="text" name="prixKg" value={form.prixKg} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Numéro de compte (MOMO/OM)</label>
              <input type="text" name="numeroCompte" value={form.numeroCompte} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
