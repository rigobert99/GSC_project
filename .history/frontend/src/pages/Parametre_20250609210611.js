        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" name="payeur" value={form.payeur} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Numéro du bénéficiaire</label>
              <input type="text" name="beneficiaire" value={form.beneficiaire} onChange={handleChange} className="w-full border rounded px-4 py-2" />
            </div>
